...
SRC_URI = "https://github.com/rdkcentral/rdke-refui/releases/download/${PV}/refui-${PV}.tar.gz;subdir=${WORKDIR}/refui-${PV}"
SRC_URI[sha256sum] = "5e75f12cb8d354d4a1e1bde292edd0c3a6cce1ec4d894304d6fc4e1470b490d6"
